    ...
    <div className="animate-fade-up">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex justify-end">
          <Link href="/forgot-password" className="font-body text-xs text-mist hover:text-gold transition-colors">
            Forgot password?
          </Link>
        </div>
      ...
      <p className="mt-8 text-center font-body text-xs text-ash">
        ...
        <Link href="/terms" className="text-mist hover:text-silver transition-colors">Terms</Link>
        {" "}and{" "}
        <Link href="/privacy" className="text-mist hover:text-silver transition-colors">Privacy Policy</Link>
      </p>
    </div>
  );
}
