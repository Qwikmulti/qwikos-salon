...
import type { Stylist, Profile } from "@prisma/client";

interface StylistWithProfile extends Stylist {
  profile: Profile;
}

interface StylistShowcaseClientProps {
  stylists: StylistWithProfile[];
}

export function StylistShowcaseClient({ stylists }: StylistShowcaseClientProps) {
  return (
